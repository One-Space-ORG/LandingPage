...
export const PulseBeams = () => {
    return (
        <div className="flex h-screen relative items-center justify-center antialiased overflow-hidden">
        {/* Background Image Container */}
        <div className="absolute inset-0 z-0">
          <div className="absolute inset-0 bg-slate-950/60 backdrop-blur-sm"></div>
          <img 
            src="https://images.unsplash.com/photo-1637775297458-7443ffd545b2?q=80&w=1854&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
            alt="Space Background"
            className="w-full h-full object-cover"
          />
        </div>
  
        {/* Button and SVGs (with increased z-index) */}
        <button className="bg-slate-800 w-[320px] z-50 h-[120px] no-underline group cursor-pointer relative shadow-2xl shadow-zinc-900 rounded-full p-px text-xs font-semibold leading-6 text-white inline-block -mt-44">
